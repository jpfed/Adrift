...
WarpPortal = {
  ...
  create = function(self,world,node)
    ...
    h:setColor(love.graphics.newColor(255,200,255,200), love.graphics.newColor(64,20,128,64))
    h:start()
    h:update(2)
    ...
    d:setColor(love.graphics.newColor(24,0,32,200), love.graphics.newColor(0,0,0,64))
    d:start()
    d:update(2)
