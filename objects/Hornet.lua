...
love.filesystem.require("objects/Convex.lua")
love.filesystem.require("objects/Engine.lua")
...
Hornet = {
  ...
  create = function(self, world, x, y, difficulty)
    ...
    local result = DamageableObject:create(bd,sh,difficulty,nil,Hornet.deathSound, 1000)
